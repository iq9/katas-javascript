...
function haveTime(walk) {
  ...
  return (steps === maxSteps && location[0] === 0 && location[1] === 0);
}

walkErr = ['w'];
walk = ['n', 'n', 'e', 'e', 's', 's', 's'];
walk2 = ['n', 'n', 'e', 'e', 's', 's', 'w', 'w'];

console.log(haveTime(walk));
console.log(haveTime(walk2));
console.log(haveTime(walkErr));